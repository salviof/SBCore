 ...
 */
public class UtilCRCReflexaoAtributoDeObjeto extends UtilCRCReflexaoAtributoDeObjetoSimples {
    ...
    private static GrupoCampos gerarGrupoCampoSemCampos(InfoGrupoCampo pAnotacaoGrupoCampo, Class pClasseEntidade) {
        ...
        if (UtilCRCStringValidador.isNuloOuEmbranco(pAnotacaoGrupoCampo.titulo())) {
            InfoObjetoSB infoObjeto = UtilCRCReflexaoObjeto.getInfoClasseObjeto(pClasseEntidade);
