 ...
 * @author salvioF
 */
public class UtilCRCReflecaoIEstruturaEntidade {
    ...
    public static InfoCalculo getAnotacaoCalulo(Field pCampo) {
        try {
            ...
            Logger.getLogger(UtilCRCReflecaoIEstruturaEntidade.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    public static ItfListas getListaByField(Field pCampo) throws UnsupportedOperationException {
        try {
            ...
            pCampo.setAccessible(true);
            Annotation anotacao = UtilCRCReflexao.getAnotacaoComEsteMetodo(pCampo.getAnnotations(), "lista");
