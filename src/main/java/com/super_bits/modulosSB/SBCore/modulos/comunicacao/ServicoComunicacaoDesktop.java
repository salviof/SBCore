 ...
 * @author salvio
 */
public class ServicoComunicacaoDesktop extends CentralComunicaoAbstrato {

    public ServicoComunicacaoDesktop(Class pServicoRepositorio) {
        super(pServicoRepositorio);
    }
