 ...
 *
 */
public class UtilCRCStringNomeArquivosEDiretorios {
    ...
    public static String getDiretorioMenosXCasas(String pDiretorio, int numeroCasas) {
        return UtilCRCDiretoriosSimples.getDiretorioMenosXCasas(pDiretorio, numeroCasas);
    }
    ...
    public static String getNomeArquivo(String pDiretorio) {
        return UtilCRCDiretoriosSimples.getNomeArquivo(pDiretorio);
    }
    ...
    public static String getDiretorioArquivo(String pCaminhoCompleto) {
        return pCaminhoCompleto.replace("/" + UtilCRCDiretoriosSimples.getNomeArquivo(pCaminhoCompleto), "");
    }
