 ...
 * @author salvio
 */
public class UtilCRCStringTelefone {
    ...
    public static String gerarNumeroTelefoneInternacional(final String pTelefone) {
        ...
        String telefoneFormatoInternacional = UtilCRCStringFiltros.removeCaracteresEspeciais(pTelefone);
    ...
    public static String gerarCeluarWhatasapp(String pTelefone) {
        ...
        if (telefone.length() == 14) {
            if (telefone.charAt(5) == '9') {
                telefone = UtilCRCStringFiltros.removerCaracteres(telefone, 5);
                return telefone.replace("+", "");
            }
        }
