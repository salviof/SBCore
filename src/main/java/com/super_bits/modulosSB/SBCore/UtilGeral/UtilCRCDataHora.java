...
public class UtilCRCDataHora {
    ...
    public static Date converteStringDD_MM_YYYYEmData(String pString) {
        Date dataConvertida;
        if (UtilCRCStringValidador.isNuloOuEmbranco(pString)) {
            return null;
        }
        try {
            SimpleDateFormat formatador = new SimpleDateFormat("dd/MM/yyyy");
    ...
    public static Date getUltimoDiaDoMes(Date pDdata) {
        ...
        LocalDate calendario = UtilCRCDataHoraCalendarioLocal.gerarLocalDateByDate(pDdata);
        ...
        try {
            ...
            Logger.getLogger(UtilCRCDataHora.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    public static Date getPrimeiroDiaDoMes(Date pDia) {
        ...
        int mesVencimento = UtilCRCDataHora.getMes(pDia) + 1;
        int ano = UtilCRCDataHora.getAno(pDia);
