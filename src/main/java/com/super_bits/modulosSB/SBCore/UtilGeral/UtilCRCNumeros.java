...
public class UtilCRCNumeros {
    ...
    public static final Double getDoublePorString(String pValorDouble) {
        try {
            ...
            try {
                caracterSeparadorDecimal = UtilCRCNumeros.getSeparadorDecimal(pValorDouble);
            ...
            String valorApenasNumero = UtilCRCStringFiltros.filtrarApenasNumeros(pValorDouble);
            ...
            parteInteiro = UtilCRCStringFiltros.filtrarApenasNumeros(parteInteiro);
