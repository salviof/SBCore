...
import com.super_bits.modulosSB.SBCore.modulos.objetos.entidade.basico.ComoEntidadeSomenteLeituraInstanciado;

/**
 *
 * @author desenvolvedor
 */
public class UtilCRCListas {
    ...
    public static String getAtributoSeparadosPorPontoVirgula(List<? extends ComoEntidadeSimples> pItens, String pAtributo) {
        ...
        pItens.stream().filter(item -> UtilCRCStringValidador.isNAO_NuloNemBranco(item.getCampoInstanciadoByNomeOuAnotacao(pAtributo).getValor().toString()))
