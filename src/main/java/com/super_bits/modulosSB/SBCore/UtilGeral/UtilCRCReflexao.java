 ...
 * @author Salvio
 */
public abstract class UtilCRCReflexao extends UtilCRCReflexaoSimples {
        ...
        for (Field campo : fields) {
            if (campo.getType().getName().equals(tipoProcurado.getName())) {
                ...
                try {
                    ...
                    Logger.getLogger(UtilCRCReflexao.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        return resposta;
    ...
    public static List<Field> instanciarListas(Object instancia) {
        ...
        List<Class> classes = UtilCRCReflexao.getClassesComHierarquiaAteNomeObjetoFinalConterNoInicio(instancia.getClass(), "Entidade", "ItemGenerico");
        List<Field> resposta = new ArrayList<>();
