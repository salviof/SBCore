 ...
 */
public abstract class UtilCRCStringSlugs {
    ...
    public static String gerarSlugSimplesForcandoMaiusculoAposEspaco(String pValor) {
        ...
        String slug = UtilCRCStringsCammelCase.getCamelByTextoPrimeiraLetraMaiuscula(pValor);
        String slugfinalizada = UtilCRCStringSlugs.gerarSlugSimples(slug);
        return slugfinalizada;
    }

    public static String gerarSlugCaixaBaixa(String pValor) {
        return UtilCRCStringFiltros.gerarUrlAmigavel(pValor).toLowerCase();
    }
    ...
    public static String formatarSlugDeConteudo(String pDominio, String pSlug) {
        ...
        String slugConteudo = UtilCRCStringFiltros.removeEspacamentoDuploEUltimoEspacaomento(pSlug);
    ...
    public static String getSlugPagina(String pSlug) {
        ...
        if (UtilCRCStringValidador.isNuloOuEmbranco(pSlug)) {
            return null;
        }
        if (pSlug.endsWith("/")) {
            return pSlug;
