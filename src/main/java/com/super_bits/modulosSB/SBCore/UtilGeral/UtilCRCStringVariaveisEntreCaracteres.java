...
public class UtilCRCStringVariaveisEntreCaracteres {
    ...
    public static List<String> extrairVariaveisEntreAspas(String pValor) {
        return UtilCRCStringValidador.getListaStringEntreCaracter(pValor, UtilCRCStringValidador.TIPO_SINALIZADOR.ASPAS);
    }

    public static List<String> extrairVariaveisEntreNenorMaior(String pValor) {
        return UtilCRCStringValidador.getListaStringEntreCaracter(pValor, UtilCRCStringValidador.TIPO_SINALIZADOR.TAG);
    }
