...
public class UtilCRCResources {
    ...
    public static boolean criarArquivoResourceEmDestino(Class classeDoResource, String caminhoArquivoResource, String destinoArquivo) {
        return UtilCRCArquivos.copiarArquivoResourceJar(classeDoResource, caminhoArquivoResource, destinoArquivo);
    }
    ...
    public static long getHashCodeClasseDoPacote(Class pClass) {
        ...
        try {
            ...
            Logger.getLogger(UtilCRCResources.class.getName()).log(Level.SEVERE, null, ex);
        }
        return -1;
    }
