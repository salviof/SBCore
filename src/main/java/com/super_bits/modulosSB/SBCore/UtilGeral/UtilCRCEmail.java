 ...
 */
public abstract class UtilCRCEmail {
    ...
    public static void verificarConfiguracao() {
        ...
        if (configuracao == null) {
            throw new UnsupportedOperationException("O servidor padrão para email transacional não foi enviado,"
                    + " execute " + UtilCRCEmail.class.getSimpleName() + ".configurar(configuracao); ao iniciar o projeto, ou defina as variaveis de ambiente do  " + FabConfigModuloEmailService.class.getSimpleName() + ".class");
        }
    ...
    private static String enviarEmail(String pEnderecoServidor, final String pFromEmail, final String pNomeFrom, final String pUsuario,
        ...
        try {
            ...
            email.setMsg(UtilCRCEmail.gerarConteudoEmailNormatizado(pMensagem));
