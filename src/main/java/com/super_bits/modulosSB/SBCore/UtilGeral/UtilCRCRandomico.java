 ...
 */
public abstract class UtilCRCRandomico {
    ...
    public static String getValorStringRandomico(TIPO_VALOR_RANDON pTipo, int tamanho) {
        ...
        switch (pTipo) {
            ...
            case LETRAS:
                ...
                String palavra = UtilCRCStringGerador.GetLorenIpsilum(numeropalavras, TIPO_LOREN.PALAVRAS);
            ...
            case DATA:
                return UtilCRCDataHora.converteDateEmSTringDD_MM_YY(new Date());
    ...
    public static String getValorStringRandomicoViaMaskara(String maskara) {
        if (UtilCRCStringValidador.isNuloOuEmbranco(maskara)) {
