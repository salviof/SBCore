 ...
 */
public class UtilCRCStringSearchTest {

    public UtilCRCStringSearchTest() {
    }
    ...
    public void testIsParecido() {
        ...
        FabCidadesSemPersistencia.getCidadesPorEstado(FabUnidadesFederativasSemPersistencia.MG).forEach(cidade -> {
            ...
            System.out.println(UtilCRCStringComparador.isParecido(cidade.getNome(), "belos horizonte"));
        });
