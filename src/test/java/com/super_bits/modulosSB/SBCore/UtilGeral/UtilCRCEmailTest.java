 ...
 */
public class UtilCRCEmailTest {

    public UtilCRCEmailTest() {
    }
    ...
    public void testEnviarPorServidorPadrao() {
        UtilCRCEmail.configurar(new ConfigEmailServersProjeto("", "", ""));
        UtilCRCEmail.enviarPorServidorPadraoV2("salviof@gmail.com", "sdjflkajsdflkajsdf <b> asasdfasdfa </b>", "asdfasdfa");
