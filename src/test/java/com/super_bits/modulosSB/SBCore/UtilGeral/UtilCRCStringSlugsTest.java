 ...
 */
public class UtilCRCStringSlugsTest {
    ...
    public void testGerarSlugCaixaAlta() {
        ...
        String retorno = UtilCRCStringSlugs.getSlugPagina("casanovadigital.com.br/home/fullBanner.frase1");
        System.out.println(retorno);
        assertEquals(retorno, "casanovadigital.com.br/home/");

        String retorno2 = UtilCRCStringSlugs.getSlugPagina("/home/fullBanner.frase1");
        System.out.println(retorno2);
        assertEquals(retorno2, "/home/");

        String retorno3 = UtilCRCStringSlugs.getSlugPagina("casanovadigital.com.br/home");
        System.out.println(retorno3);
        assertEquals(retorno3, "casanovadigital.com.br/");
        String retorno4 = UtilCRCStringSlugs.getSlugPagina("casanovadigital.com.br/servicos");
        System.out.println(retorno4);
        assertEquals(retorno4, "casanovadigital.com.br/");
        String retorno5 = UtilCRCStringSlugs.getSlugPagina("casanovadigital.com.br/servicos/");
        System.out.println(retorno5);
        assertEquals(retorno5, "casanovadigital.com.br/servicos/");

        String retorno6 = UtilCRCStringSlugs.getSlugPagina("servicosDestaque.produto1");
        System.out.println(retorno6);
        assertEquals(retorno6, "/");

        String retorno7 = UtilCRCStringSlugs.getSlugPagina("casanovadigital.com.br/servicos/destaque.banner");
    ...
    public void testGerarSlugCaixaAltaByCammelCase() {
        ...
        String result = UtilCRCStringSlugs.gerarSlugCaixaAltaByCammelCase("gerarSlugCaixaAltaByCammelCase");
    ...
    /**
     * Test of gerarSlugSimples method, of class UtilCRCStringSlugs.
     */
    @Test
    public void testGerarSlugSimples() {
        ...
        String pValor = "";
        String expResult = "";
        String result = UtilCRCStringSlugs.gerarSlugSimples(pValor);
    ...
    public void testGerarSlugSimplesForcandoMaiusculoAposEspaco() {
        ...
        String pValor = "";
        String expResult = "";
        String result = UtilCRCStringSlugs.gerarSlugSimplesForcandoMaiusculoAposEspaco(pValor);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
    ...
    /**
     * Test of gerarSlugCaixaBaixa method, of class UtilCRCStringSlugs.
     */
    @Test
    public void testGerarSlugCaixaBaixa() {
        ...
        String pValor = "";
        String expResult = "";
        String result = UtilCRCStringSlugs.gerarSlugCaixaBaixa(pValor);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
    ...
    /**
     * Test of formatarSlugDeConteudo method, of class UtilCRCStringSlugs.
     */
    @Test
    public void testFormatarSlugDeConteudo() {
        ...
        String pSlug = "";
        String expResult = "";
        String result = UtilCRCStringSlugs.formatarSlugDeConteudo(pDominio, pSlug);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
    ...
    /**
     * Test of getSlugPagina method, of class UtilCRCStringSlugs.
     */
    @Test
    public void testGetSlugPagina() {
        ...
        String pSlug = "";
        String expResult = "";
        String result = UtilCRCStringSlugs.getSlugPagina(pSlug);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
